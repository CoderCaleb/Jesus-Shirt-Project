      ...
      return (
        <div className="flex justify-center items-center h-full w-full p-10">
          <div className="text-center">
            <p className="text-xl font-semibold text-red-500">An error occurred</p>
            <p className="mt-2 text-gray-700">We couldn't load the product details. Please try again later.</p>
          </div>
        </div>
      );
    }
